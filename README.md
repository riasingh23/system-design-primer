...
<img width="645" height="690" alt="image" src="https://github.com/user-attachments/assets/05a30fdc-7f83-472a-a744-0c29d9efcc81" />
...
If the sender does not receive a correct response, it will resend the packets.  If there are multiple timeouts, the connection is dropped.  TCP also implements [flow control](https://en.wikipedia.org/wiki/Flow_control_(data)) and [congestion control](https://en.wikipedia.org/wiki/Network_congestion#Congestion_control). Congestion control prevents senders from overwhelming the network, flow control prevents the sender from overwhelming the receiver.  These guarantees cause delays and generally result in less efficient transmission than UDP.
